...
export default function SharedChartPage({ params }: { params: Promise<{ token: string }> }) {
    ...
    return (
      <main className="min-h-screen bg-gradient-to-b from-secondary to-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground font-sans">Loading shared chart...</p>
        </div>
      </main>
    );
  }
      ...
      <main className="min-h-screen bg-gradient-to-b from-secondary to-white flex items-center justify-center px-4">
        <Card className="max-w-md w-full">
          <CardHeader>
            ...
            <CardDescription>{error || 'Shared chart not found'}</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              This share link may have been deactivated or expired.
            </p>
            <Link href="/">
    ...
    return (
      <main className="min-h-screen bg-gradient-to-b from-secondary to-white flex items-center justify-center px-4">
        <Card className="max-w-md w-full">
          ...
          <CardContent>
            <Link href="/">
              <Button className="w-full">Create Your Own Chart</Button>
            </Link>
          </CardContent>
        </Card>
      </main>
    ...
    <main className="min-h-screen bg-gradient-to-b from-secondary via-white to-secondary/30">
      ...
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-border py-4 px-4">
        <div className="container mx-auto flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 text-primary hover:text-accent transition-colors">
            ...
            <span className="font-medium hidden sm:inline">Total Human Design</span>
          </Link>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <p className="font-accent text-lg text-accent mb-2">Human Design Chart</p>
                    ...
                    <div className="space-y-3">
                      <div className="p-4 bg-secondary/50 rounded-lg">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          {chart.definition === 'Single' && 'All defined centers are connected'}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-accent/10 rounded-lg border border-accent/20">
                      <p className="text-sm text-foreground leading-relaxed">
                        As a <strong>{chart.type}</strong>, the strategy is to <strong>{typeInfo.strategy.toLowerCase()}</strong>.
                        Following this strategy leads to experiencing <strong>{typeInfo.signature.toLowerCase()}</strong>.
                        Otherwise, the feeling is <strong>{typeInfo.notSelfTheme.toLowerCase()}</strong>.
                      </p>
                    </div>
                    <div className="p-4 bg-accent/10 rounded-lg border border-accent/20">
                      <p className="text-sm font-medium text-primary mb-2">Making Decisions</p>
                      <p className="text-sm text-foreground leading-relaxed">
                        {chart.authority} authority means: {AUTHORITY_INFO[chart.authority]?.strategy || 'Trust your inner knowing.'}
                      </p>
                    </div>
                  </div>
                </div>
        ...
        {/* CTA to Create Own Chart */}
        <div className="mt-8 text-center">
          <Card className="max-w-md mx-auto bg-gradient-to-br from-accent/10 to-primary/10 border-accent/30">
            <CardContent className="pt-6">
              <Sparkles className="w-12 h-12 text-accent mx-auto mb-4" />
              <h3 className="font-accent text-xl text-primary mb-2">Discover Your Own Design</h3>
              <p className="text-sm text-muted-foreground mb-4">
                Want to see your unique Human Design chart? Create your own for free!
              </p>
              <Link href="/">
